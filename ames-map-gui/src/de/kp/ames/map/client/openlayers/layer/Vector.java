...
import de.kp.ames.map.client.openlayers.event.VectorBeforeFeatureAddedListener;
import de.kp.ames.map.client.openlayers.event.VectorFeatureAddedListener;
import de.kp.ames.map.client.openlayers.event.VectorFeatureModifiedListener;
import de.kp.ames.map.client.openlayers.event.VectorFeatureRemovedListener;
import de.kp.ames.map.client.openlayers.event.VectorFeatureSelectedListener;
import de.kp.ames.map.client.openlayers.event.VectorFeatureUnselectedListener;
import de.kp.ames.map.client.openlayers.event.VectorBeforeFeatureAddedListener.BeforeFeatureAddedEvent;
import de.kp.ames.map.client.openlayers.event.VectorFeatureAddedListener.FeatureAddedEvent;
import de.kp.ames.map.client.openlayers.event.VectorFeatureModifiedListener.FeatureModifiedEvent;
import de.kp.ames.map.client.openlayers.event.VectorFeatureRemovedListener.FeatureRemovedEvent;
import de.kp.ames.map.client.openlayers.event.VectorFeatureSelectedListener.FeatureSelectedEvent;
import de.kp.ames.map.client.openlayers.event.VectorFeatureUnselectedListener.FeatureUnselectedEvent;
