...
public class Popup extends OpenLayersObjectWrapper {
	 ...
	 * @param lonlat - {@link de.kp.ames.map.client.openlayers.LonLat} where Popup should appear
	 * @param size - {@link de.kp.ames.map.client.openlayers.Size} that provides height and width for Popup
