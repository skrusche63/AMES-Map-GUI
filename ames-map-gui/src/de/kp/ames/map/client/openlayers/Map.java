...
import de.kp.ames.map.client.openlayers.MapImpl;
...
import de.kp.ames.map.client.openlayers.event.MapBaseLayerChangedListener;
import de.kp.ames.map.client.openlayers.event.MapClickListener;
import de.kp.ames.map.client.openlayers.event.MapLayerAddedListener;
import de.kp.ames.map.client.openlayers.event.MapLayerChangedListener;
import de.kp.ames.map.client.openlayers.event.MapLayerRemovedListener;
import de.kp.ames.map.client.openlayers.event.MapMarkerAddedListener;
import de.kp.ames.map.client.openlayers.event.MapMarkerRemovedListener;
import de.kp.ames.map.client.openlayers.event.MapMoveListener;
import de.kp.ames.map.client.openlayers.event.MapPopupClosedListener;
import de.kp.ames.map.client.openlayers.event.MapPopupOpenedListener;
import de.kp.ames.map.client.openlayers.event.MapZoomListener;
import de.kp.ames.map.client.openlayers.event.MapBaseLayerChangedListener.MapBaseLayerChangedEvent;
import de.kp.ames.map.client.openlayers.event.MapClickListener.MapClickEvent;
import de.kp.ames.map.client.openlayers.event.MapLayerAddedListener.MapLayerAddedEvent;
import de.kp.ames.map.client.openlayers.event.MapLayerChangedListener.MapLayerChangedEvent;
import de.kp.ames.map.client.openlayers.event.MapLayerRemovedListener.MapLayerRemovedEvent;
import de.kp.ames.map.client.openlayers.event.MapMarkerAddedListener.MapMarkerAddedEvent;
import de.kp.ames.map.client.openlayers.event.MapMarkerRemovedListener.MapMarkerRemovedEvent;
import de.kp.ames.map.client.openlayers.event.MapMoveListener.MapMoveEvent;
import de.kp.ames.map.client.openlayers.event.MapPopupClosedListener.MapPopupClosedEvent;
import de.kp.ames.map.client.openlayers.event.MapPopupOpenedListener.MapPopupOpenedEvent;
import de.kp.ames.map.client.openlayers.event.MapZoomListener.MapZoomEvent;
import de.kp.ames.map.client.openlayers.layer.Layer;
import de.kp.ames.map.client.openlayers.popup.Popup;
 ...
 * it’s necessary to add controls, see {@link de.kp.ames.map.client.openlayers.control.Control}
 * and layers, see {@link de.kp.ames.map.client.openlayers.layer.Layer}
 * to the map.
 *
 * </p>
 * @author Erdem Gunay
...
public class Map extends OpenLayersEObjectWrapper {
	 ...
	 * A {@link de.kp.ames.map.client.openlayers.layer.Layer} can be asked for it's id. This id can be used
