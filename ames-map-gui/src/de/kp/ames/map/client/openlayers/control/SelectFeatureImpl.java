...
class SelectFeatureImpl {
	...
	public static native JSObject createSelectFeatureCallback(SelectFeatureListener listener)/*-{
		var callback = function(obj){
			...
			listener.@de.kp.ames.map.client.openlayers.control.SelectFeature.SelectFeatureListener::onFeatureSelected(Lde/kp/ames/map/client/openlayers/feature/VectorFeature;)(vectorFeatureObj);
		}
		return callback;
	}-*/;
	...
	public static native JSObject createUnselectFeatureCallback(UnselectFeatureListener listener)/*-{
		var callback = function(obj){
			var vectorFeatureObj = @de.kp.ames.map.client.openlayers.feature.VectorFeature::narrowToVectorFeature(Lde/kp/ames/map/client/openlayers/util/JSObject;)(obj);
			listener.@de.kp.ames.map.client.openlayers.control.SelectFeature.UnselectFeatureListener::onFeatureUnselected(Lde/kp/ames/map/client/openlayers/feature/VectorFeature;)(vectorFeatureObj);
		}
		return callback;
	}-*/;
