...
public abstract class MousePositionOutput {
	 ...
	 *
	 * @param lonLat - a {@link de.kp.ames.map.client.openlayers.LonLat} with the longitude/latitude at the mouse position
	 * @param map - the {@link de.kp.ames.map.client.openlayers.Map} to which the control has been added.
