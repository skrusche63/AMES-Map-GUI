...
import de.kp.ames.map.client.openlayers.event.LayerLoadCancelListener;
import de.kp.ames.map.client.openlayers.event.LayerLoadEndListener;
import de.kp.ames.map.client.openlayers.event.LayerLoadStartListener;
import de.kp.ames.map.client.openlayers.event.LayerVisibilityChangedListener;
import de.kp.ames.map.client.openlayers.event.LayerLoadCancelListener.LoadCancelEvent;
import de.kp.ames.map.client.openlayers.event.LayerLoadEndListener.LoadEndEvent;
import de.kp.ames.map.client.openlayers.event.LayerLoadStartListener.LoadStartEvent;
import de.kp.ames.map.client.openlayers.event.LayerVisibilityChangedListener.VisibilityChangedEvent;
