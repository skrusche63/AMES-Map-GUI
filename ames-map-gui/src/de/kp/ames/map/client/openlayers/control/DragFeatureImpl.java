...
public class DragFeatureImpl {
	...
	public static native JSObject createStartDragCallback(StartDragListener listener)/*-{
		var callback = function(o,p){
			var vectorFeatureObj = @de.kp.ames.map.client.openlayers.feature.VectorFeature::narrowToVectorFeature(Lde/kp/ames/map/client/openlayers/util/JSObject;)(o);
			var pixelObject = @de.kp.ames.map.client.openlayers.Pixel::narrowToPixel(Lde/kp/ames/map/client/openlayers/util/JSObject;)(p);
			listener.@de.kp.ames.map.client.openlayers.control.DragFeature.StartDragListener::onStart(Lde/kp/ames/map/client/openlayers/feature/VectorFeature;Lde/kp/ames/map/client/openlayers/Pixel;)(vectorFeatureObj,pixelObject);
		}
		return callback;
	}-*/;
	...
	public static native JSObject createDragCallback(DragListener listener)/*-{
		var callback = function(o,p){
			var vectorFeatureObj = @de.kp.ames.map.client.openlayers.feature.VectorFeature::narrowToVectorFeature(Lde/kp/ames/map/client/openlayers/util/JSObject;)(o);
			var pixelObject = @de.kp.ames.map.client.openlayers.Pixel::narrowToPixel(Lde/kp/ames/map/client/openlayers/util/JSObject;)(p);
			listener.@de.kp.ames.map.client.openlayers.control.DragFeature.DragListener::onDrag(Lde/kp/ames/map/client/openlayers/feature/VectorFeature;Lde/kp/ames/map/client/openlayers/Pixel;)(vectorFeatureObj,pixelObject);
		}
		return callback;
	}-*/;
	...
	public static native JSObject createCompleteCallback(CompleteListener listener)/*-{
		var callback = function(o,p){
			var vectorFeatureObj = @de.kp.ames.map.client.openlayers.feature.VectorFeature::narrowToVectorFeature(Lde/kp/ames/map/client/openlayers/util/JSObject;)(o);
			var pixelObject = @de.kp.ames.map.client.openlayers.Pixel::narrowToPixel(Lde/kp/ames/map/client/openlayers/util/JSObject;)(p);
			listener.@de.kp.ames.map.client.openlayers.control.DragFeature.CompleteListener::onComplete(Lde/kp/ames/map/client/openlayers/feature/VectorFeature;Lde/kp/ames/map/client/openlayers/Pixel;)(vectorFeatureObj,pixelObject);
		}
		return callback;
	}-*/;
